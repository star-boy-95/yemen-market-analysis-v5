    ...
    def generate_all_visualizations(self, data: Dict[str, pd.DataFrame], unit_root_results: Dict[str, Any],
        ...
        try:
            ...
            for market_name, market_data in data.items():
                ...
                fig, ax = self.plot_time_series(y_column='price', title=f"{market_name} - Price Time Series")
            ...
            raise YemenAnalysisError(f"Error generating time series visualizations: {e}")

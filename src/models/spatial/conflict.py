        ...
        try:
            ...
            for market in markets:
                ...
                transmission_results[market] = {
                    'coefficients': {
                        'constant': results.params[0],
                        'reference_price': results.params[1],
                        'conflict': results.params[2],
                        'interaction': results.params[3],
                    },
                    'std_errors': {
                        'constant': results.bse[0],
                        'reference_price': results.bse[1],
                        'conflict': results.bse[2],
                        'interaction': results.bse[3],
                    },
                    'p_values': {
                        'constant': results.pvalues[0],
                        'reference_price': results.pvalues[1],
                        'conflict': results.pvalues[2],
                        'interaction': results.pvalues[3],
                    },
                    't_values': {
                        'constant': results.tvalues[0],
                        'reference_price': results.tvalues[1],
                        'conflict': results.tvalues[2],
                        'interaction': results.tvalues[3],
                    },
                    'r_squared': results.rsquared,
                    'adj_r_squared': results.rsquared_adj,
                    'f_statistic': results.fvalue,
